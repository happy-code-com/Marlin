...
#define STRING_CONFIG_H_AUTHOR "Happy" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "FBG5 Robin nano"
...
#define HOTEND_OFFSET_Z { -0.84, 0.00 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2800, 3000, 100, 10000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 46, -25, -1.19 }
...
#define HOMING_FEEDRATE_MM_M { 500, 500, 150 }
